...
def plotar_matriz_interativa(tabela, output_dir, nome_arquivo):
    ...
    colunas = [
        [1],  # Gráfico 1: Coluna 1 
        [2],  # Gráfico 2: Coluna 2
        [3],  # Gráfico 3: Coluna 3
        [4],  # Gráfico 4: Coluna 4
        [5],  # Gráfico 5: Coluna 5
        [6],  # Gráfico 6: Coluna 6
        [7],  # Gráfico 7: Coluna 7
        [8],  # Gráfico 8: Coluna 8
        [9]   # Gráfico 9: Coluna 9
    ]
    
    # Define os nomes das linhas para os gráficos
    nomes_linhas = [
        ['X(m/s²)'], 
        ['Y(m/s²)'], 
        ['Z(m/s²)'],     # Nomes para o gráfico 
        ['X(°/s)'], 
        ['Y(°/s)'], 
        ['Z(°/s)'],      # Nomes para o gráfico 
        ['Roll(°)'], 
        ['Pitch(°)'], 
        ['Yaw(°)']       # Nomes para o gráfico 
    ]
    
    # Define os nomes do eixo y para os gráficos
    y_labels = [
        'Aceleração (m/s²)', 
        'Aceleração (m/s²)', 
        'Aceleração (m/s²)',                      
